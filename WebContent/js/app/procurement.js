	...
	pro_datagrid = $('#pro_datagrid').datagrid({
        ...
        columns: [ 
            [ 
              ...
              {field: 'status',title: '状态',width: fixWidth(0.2),align: 'center', halign: 'center',sortable: true,
            	  formatter:function(value, row){
            		  switch (value) {
            	  ...
            	  formatter: function(value, row) {
            		  switch (value) {
						case "WAIT_FOR_PROCUREMENT":
							return "<span class='text-warning'>待采购</span>";
						case "PROCUREMENT":
							return "<span class='text-primary'>采购中</span>";
						case "IN_BOUNDABLE":
    ...
    pro_dialog = $('<div/>').dialog({
        ...
        buttons: [
            ...
            },
            {
            	...
            	id: 'ok',
            	handler: function () {
            		var url_ = ctx+"/tunhuoProcurement/callApproval";
            		if(type == "buhuo") {
            			url_ = ctx+"/buhuoProcurement/callApproval";
            		}
