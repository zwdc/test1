...
<body>
	<div title="选择人员" style="width:986px;height:364px;">
		<div class="easyui-layout" data-options="fit:true">
							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${groupList}" var="group">
										<li><a href="javascript:void(0);" onclick="addTab('${group.name}','${group.id }','${key }','${multiSelect }');"><span>${group.name}</span></a></li>
									</c:forEach>
								</c:otherwise>
							</c:choose>  
						</ul>
			...
			<div region="south" border="false" style="text-align:right;height:30px;line-height:30px;">
				...
				<a class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)" onclick="destroy_chooseUser('${key }');">取消</a>
			</div>
		</div>
	</div>
